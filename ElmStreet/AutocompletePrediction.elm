module ElmStreet.AutocompletePrediction exposing (AutocompletePrediction, StructuredFormatting, PredictionTerm, PredictionSubstring, decodeAutocompletePrediction)
...
@docs decodeAutocompletePrediction
